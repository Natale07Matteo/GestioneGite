        ...
        <main class="content home-padding">
            ...
            <?php if (!$ruolo): ?>
                ...
                <div class="hero-section" style="text-align: center; margin-top: 5rem;">
                    ...
                    <p style="font-size: 1.1rem; max-width: 600px; margin: 0 auto; color: #475569;">Benvenuto nel portale
                        per l'organizzazione dei viaggi d'istruzione. Accedi con il tuo account del Portale Calvino per
                        iniziare.</p>
                </div>
                <div style="max-width: 450px; margin: 3rem auto 6rem;">
                    <div class="card centered"
                        style="padding: 2.5rem 2rem; box-shadow: 0 4px 20px rgba(59, 130, 246, 0.1);">
                        ...
                        <div class="card-body" style="margin-bottom: 1.5rem;">
                            <p style="font-size: 1rem; color: #64748b; margin: 0;">Effettua il login tramite il Portale
                                Calvino per accedere alle funzionalità.</p>
                        </div>
                        <div class="card-footer"
                            style="justify-content: center; border: none; padding-top: 0; margin-top: 0;">
                            <a href="login.php" class="button full-width home-button"
                                style="height: 3.5rem; font-size: 1.1rem;">Accedi con Portale Calvino</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                ...
                <div class="hero-section" style="margin-top: 2rem; margin-bottom: 3rem;">
                    <h1 style="font-size:2.5rem;font-weight:700;margin-bottom:0.5rem;color:var(--blue-700);">Benvenuto,
                        <?php echo htmlspecialchars(explode(' ', $nome_utente)[0]); ?>
                    </h1>
                ...
                <div class="home-grid <?php echo $gridClass; ?>" style="margin-bottom: 2rem; margin-top: 0;">
                    <div class="card stat-card" onclick="window.location.href='mieGite.php'"
                        style="text-align:center;padding:1.2rem;">
                        <span
                            style="font-size:2rem;font-weight:700;color:var(--blue-600);"><?php echo $totProposte; ?></span>
                    ...
                    <div class="card stat-card" onclick="window.location.href='inProgramma.php'"
                        style="text-align:center;padding:1.2rem;">
                        <span
                            style="font-size:2rem;font-weight:700;color:var(--blue-600);"><?php echo $totInProgramma; ?></span>
                        <p style="font-size:0.85rem;color:var(--my-gray);margin-top:0.3rem;">Gite in programma</p>
                    </div>
                    <?php if ($ruolo == 2): ?>
                        <div class="card stat-card" onclick="window.location.href='elencoBozze.php'"
                            style="text-align:center;padding:1.2rem;">
                            <span
                                style="font-size:2rem;font-weight:700;color:<?php echo $coloreBozze; ?>;"><?php echo $totBozze; ?></span>
