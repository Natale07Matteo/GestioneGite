    ...
    <div class="manuale-container">
        ...
        <article class="manuale-content">
            ...
            <section>
                ...
                <p>L'accesso al Portale Gestione Gite avviene tramite <strong>Single Sign-On (SSO)</strong> integrato con il <strong>Portale Calvino</strong>.</p>
                
                <p>Non è necessaria alcuna registrazione separata o la gestione di credenziali dedicate: l'autenticazione si effettua in modo sicuro utilizzando l'account istituzionale Google.</p>
                ...
                <div class="manuale-alert manuale-alert-tip">
                    ...
                    <div>
                        <strong>Creazione automatica del profilo:</strong> Al primo accesso riuscito tramite il Portale Calvino, il sistema creerà automaticamente la tua utenza locale, assegnandoti il ruolo di <em>Docente</em> o <em>Commissione</em> in base ai tuoi ruoli sul portale istituzionale.
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <p>Nelle sezioni <strong>Proposte</strong> e <strong>Bozze</strong> sono disponibili i seguenti strumenti per agevolare la consultazione delle tabelle:</p>
                <ul>
                    ...
                    <li><strong>"Vai a gite per le quinte":</strong> il pulsante posizionato accanto alla barra di ricerca permette di scorrere rapidamente fino alla tabella delle gite di più giorni (gite di più giorni), evitando di dover scorrere manualmente l'intera pagina.</li>
                </ul>
