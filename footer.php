<footer class="main-footer">
    <div class="footer-top">
        <div class="footer-brand-section">
            <!-- School Logo -->
            <div class="school-logo" style="background: #ffffff; padding: 4px; border-radius: 10px; width: 65px; height: 65px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            ...
            <div class="school-info-text">
                <span class="school-title">Istituto Istruzione Superiore</span>
                <span class="school-name">Italo Calvino</span>
                <span class="school-subtext">Istituto Tecnico - Settore Tecnologico</span>
                <span class="school-subtext">Liceo Scientifico</span>
            </div>
        </div>

        <div class="footer-contacts-section">
            <p>via Borzoli 21, 16153 Genova</p>
            <p>Tel. +39 010 6508778 | +39 010 6504672</p>
            <p>Email: <a href="mailto:GEIS01400Q@istruzione.it">GEIS01400Q@istruzione.it</a></p>
            <p>PEC: <a href="mailto:GEIS01400Q@pec.istruzione.it">GEIS01400Q@pec.istruzione.it</a></p>
            <p>C.M.: GEIS01400Q | C.F.: 92014430109</p>
            <p>Codice Univoco Ufficio: UFGH6R</p>
        </div>
    </div>
